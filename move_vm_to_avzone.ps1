#Input Parameters
$subscriptionName = "Eversource-IT-prd-01"
...
$PathForVMExport = "C:\Temp\Move-AzVMToAvailabilityZone"
$resourceGroup = "RG-ITVP-Sap-Prod-USC" #Resouce group of the VM
$vmName = "c1vlq-sappoc01" #VM Name
$location = "centralus" #VM Location
$zone = "1" # 1, 2 or 3
