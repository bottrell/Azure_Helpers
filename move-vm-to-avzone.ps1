...
function Export-VMConfig {
    ...
    (
      ...
      [Parameter(Mandatory=$True, HelpMessage='name of the Resource Group of the Virtual Machine')]
      [Alias('rg')]
      [string]$ResourceGroupName,
      [Parameter(Mandatory=$True, HelpMessage='directory path for export file')]
      [Alias('path')]
